        ...
        <div id="main">
            <div id="news">
                ...
                <div class="block">
                    ...
                    <form id="form_input">
                        <div>
                            <input type="text" id="login" placeholder="Логин" onclick="$(this).css ('border-color', '#ccc')">
                        </div>
                        <div>
                        ...
                        <div>
                            <input type="password" id="password2" placeholder="Повторите пароль" onclick="$(this).css ('border-color', '#ccc')">
                        </div>
