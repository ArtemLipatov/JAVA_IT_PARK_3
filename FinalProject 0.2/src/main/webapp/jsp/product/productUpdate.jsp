        ...
        <form action="/productUpdate" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="model" value="${product.model}" required></td>
                    <td><input type="text" name="description" value="${product.description}" required></td>
                    <td><input type="text" name="color" value="${product.color}" required></td>
                    <td><input type="text" name="productCode" value="${product.productCode}" required></td>
                    <td><input type="text" name="rating" value="${product.rating}" required></td>
